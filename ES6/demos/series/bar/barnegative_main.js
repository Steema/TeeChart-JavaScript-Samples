import { Chart, Bar } from '../../../src/teechart.js';
...
const coloreach2 = document.getElementById('coloreach2');
const barstyle = document.getElementById('barstyle');

const chart1 = new Chart("canvas");

chart1.addSeries(new Bar([5,-3,2,-7,1]));
chart1.addSeries(new Bar([4,4,-8,2,-9]));
...
chart1.legend.format.shadow.visible = true;
...
chart1.panel.format.stroke.dash=[5,10,2];
...
coloreach2.onclick = () => {
  chart1.series.items[1].colorEach = coloreach2.checked ? 'yes' : 'auto'; chart1.draw();
}
